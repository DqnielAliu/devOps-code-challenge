...
resource "aws_vpc" "main_vpc" {
  ...
  tags = {
    ...
    Name        = "${var.app_name}-${var.environment}-main_vpc"
...
resource "aws_internet_gateway" "main_internet_gateway" {
  ...
  tags = {
    Application = "${var.app_name}"
    Environment = var.environment
    Name        = "${var.app_name}-${var.environment}-main_internet_gateway"
...
resource "aws_eip" "eip_for_the_nat_gateway" {
  ...
  tags = {
    Application = "${var.app_name}"
    Environment = var.environment
    Name        = "${var.app_name}-${var.environment}-${var.aws_region}-eip_for_the_nat_gateway"
...
resource "aws_subnet" "public_subnet" {
  ...
  tags = {
    Application = "${var.app_name}"
    Environment = var.environment
    Name        = "${var.app_name}-${var.environment}-${data.aws_availability_zones.available.names[count.index]}-public"
...
resource "aws_nat_gateway" "nat_gateway" {
  allocation_id = aws_eip.eip_for_the_nat_gateway[count.index].id
  ...
  tags = {
    Application = "${var.app_name}"
    Environment = var.environment
    Name        = "${var.app_name}-${var.environment}-${var.aws_region}"
...
resource "aws_subnet" "private_subnet" {
  ...
  tags = {
    Application = "${var.app_name}"
    Environment = var.environment
    Name        = "${var.app_name}-${var.environment}-${data.aws_availability_zones.available.names[count.index]}-private"
